...
<body>
    <section class="pro-order">
        ...
        <div class="pagination">
            <?php
            $totalPages = ceil($pendingProductCount / $limit); // คำนวณจำนวนหน้าทั้งหมด
            $prevPage = ($page > 1) ? $page - 1 : 1;
            $nextPage = ($page < $totalPages) ? $page + 1 : $totalPages;

            // echo "<a href='product_order2.php?page=1' class='pagination-link'>First</a>"; // ลิงก์ไปหน้าแรก

            if ($page > 1) {
                echo "<a href='product_order2.php?page=$prevPage' class='pagination-link'><</a>"; // ลิงก์หน้าก่อนหน้า
            }
            ...
            if ($page < $totalPages) {
                echo "<a href='product_order2.php?page=$nextPage' class='pagination-link'>></a>"; // ลิงก์หน้าถัดไป
            }

            // echo "<a href='product_order2.php?page=$totalPages' class='pagination-link'>Last</a>"; // ลิงก์ไปหน้าสุดท้าย
            ?>
        </div>

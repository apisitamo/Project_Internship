...
<body>
    <section class="pro-order">
        ...
        <div class="pagination">
            ...
            if ($page < $totalPages) {
                echo "<a href='course_order.php?page=$nextPage' class='pagination-link'>></a>"; // ลิงก์หน้าถัดไป
            }

            // echo "<a href='course_order.php?page=$totalPages' class='pagination-link'>Last</a>"; // ลิงก์ไปหน้าสุดท้าย
            ?>
        </div>
        ...
        <div class="popup" id="popup2">
            <div class="popup-content">
                ...
                <div class="container">
                    ...
                    <button class="button-close-2" id="confirm-delete-button" href='course_order.php?delete_id=<?php echo $row['id']; ?>'>
                        <?= $confirm ?>
                    </button>
